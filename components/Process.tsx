  ...
  return (
    <section id="process">
      <div className="text-center mb-8">
        ...
        <p className="text-[color:var(--muted)] mt-2">Transparent, structured, no surprises.</p>
      </div>

      <div className="hidden md:block">
        <motion.div className="relative flex items-center justify-between px-8">
          <div className="absolute inset-x-8 top-8 border-t border-dashed border-[color:var(--border)]" />
